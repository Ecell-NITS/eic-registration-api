        ...
        <div style="padding: 30px;">
            ...
            <div style="background-color: #111111; border: 1px solid #2a3a30; border-radius: 8px; padding: 20px; text-align: center; margin-bottom: 25px;">
                ...
                <div style="background-color: #1a1a1a; border: 1px solid #2a3a30; border-radius: 4px; padding: 12px; margin-bottom: 20px; word-break: break-all;">
                    <a href="https://chat.whatsapp.com/HBIMHfnrsaKHwQQDA3WcZX" target="_blank" style="color: #cee7d7; font-size: 14px; text-decoration: none; font-weight: bold;">https://chat.whatsapp.com/HBIMHfnrsaKHwQQDA3WcZX</a>
                </div>
                ...
                <div style="border-top: 1px solid #2a3a30; padding-top: 20px;">
                    ...
                    <a href="https://wa.me/?text=Join%20our%20team%20for%20EIC%202026!%20Here%20is%20the%20WhatsApp%20group%20link:%20https://chat.whatsapp.com/HBIMHfnrsaKHwQQDA3WcZX" target="_blank" style="display: inline-block; background-color: #25D366; color: #ffffff; text-decoration: none; padding: 10px 20px; border-radius: 6px; font-size: 14px; font-weight: bold;">Share via WhatsApp</a>
                </div>
            </div>
